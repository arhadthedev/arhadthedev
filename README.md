...
- Python interpreter:
  - **python/cpython**: [18 already merged commits](https://github.com/python/cpython/commits?author=arhadthedev), [10 PRs are awaiting review](https://github.com/python/cpython/pulls/arhadthedev), [6 reported issues](https://github.com/python/cpython/issues?q=is%3Aissue+author%3Aarhadthedev)
