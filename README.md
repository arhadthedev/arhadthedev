...
- Python interpreter:
  - **python/cpython**: [18 already merged commits](https://github.com/python/cpython/commits?author=arhadthedev), [11 PRs are awaiting review](https://github.com/python/cpython/pulls/arhadthedev), [8 reported issues](https://github.com/python/cpython/issues?q=is%3Aissue+author%3Aarhadthedev)
