...
- Python interpreter:
  - **python/cpython**: [33 already merged commits](https://github.com/python/cpython/commits?author=arhadthedev), [15 PRs are awaiting merging](https://github.com/python/cpython/pulls/arhadthedev), [21 reported issues](https://github.com/python/cpython/issues?q=is%3Aissue+author%3Aarhadthedev)
